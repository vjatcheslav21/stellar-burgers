...
type GenerateAsynkThunk = AsyncThunk<unknown, unknown, any>;
export type PendingAction = ReturnType<GenerateAsynkThunk['pending']>;
export type RejectedAction = ReturnType<GenerateAsynkThunk['rejected']>;
export type FulfilledAction = ReturnType<GenerateAsynkThunk['fulfilled']>;
